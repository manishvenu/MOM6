...
#   include "version_variable.h"
      ...
      print*, 'MRV: Called Marble Register '
      do m=1,CS%ntr
         do n=1, OBC%number_of_segments
            ...
            print*, 'MRV: Successfully Indexed = ', index, ' with num fields ', num_fields, ' cs ntr ', CS%ntr, ' m ', m
            ...
            print*, 'MRV: Successfully Parsed = ', CS%tracer_data(m)%var_name, ' with ntr_id ', ntr_id
         enddo
      enddo
